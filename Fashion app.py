...
def startup_event(last_update: str):
    ...
    embeddings = SentenceTransformerEmbeddings(model_name="all-MiniLM-L6-v2")  #Name of model used for the chatbot
    persist_directory = "chroma_db"   #Name of vector search used for the chatbot
